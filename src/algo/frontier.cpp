...
Frontier::Frontier(Workload *workload,
...
void Frontier::on_simulation_start(double date,
...
void Frontier::on_simulation_end(double date)
{
    (void) date;
}

void Frontier::make_decisions(double date,
    ...
    SortableJobOrder::CompareInformation *compare_info)
{
    ...
    // This algorithm is a version of Frontier without backfilling.
    // It is meant to be fast in the usual case, not to handle corner cases.
    // It is not meant to be easily readable or hackable ;).

    // This fast Frontier variant in a few words:
    // - only handles the Frontier queue order
